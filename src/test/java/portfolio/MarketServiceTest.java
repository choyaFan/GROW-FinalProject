...
public class MarketServiceTest {
    ...
    public void testIndices(){
        assertEquals("{\"NASDAQ\":\"-0.60%\",\"S&P 500\":\"0.05%\",\"DOW JONES\":\"0.48%\",\"SSE Composite Index\":\"0.57%\"}", service.getIndices());
    }

    @Test
    public void testGainer(){
        assertEquals("{\"Cadence\":1.67,\"Ares\":1.36,\"Diageo plc\":0.17}",service.getGainers());
    }

    @Test
    public void testLoser() {
        assertEquals("{\"NexPoint\":-0.62,\"Itau\":-0.59,\"Silicon\":-0.34,\"Valley\":-0.26,\"Echo\":-0.17}", service.getLosers());
    }
